...
-- Create bucket "club-logos"
INSERT INTO storage.buckets (id, name, public)
VALUES ('club-logos', 'club-logos', true)
ON CONFLICT (id) DO NOTHING;

-- Public read access for club logos (navbar, etc.)
CREATE POLICY "Public read for club-logos"
ON storage.objects
FOR SELECT
USING (bucket_id = 'club-logos');

-- Insert: PUBLIC (anon + authenticated), restricted to this bucket
CREATE POLICY "Club logos insert (public)"
ON storage.objects
FOR INSERT
TO public
WITH CHECK (bucket_id = 'club-logos');

-- Update: authenticated users, restricted to this bucket
CREATE POLICY "Club logos update"
ON storage.objects
FOR UPDATE
TO authenticated
USING (bucket_id = 'club-logos')
...
-- Delete: authenticated users, restricted to this bucket
CREATE POLICY "Club logos delete"
ON storage.objects
FOR DELETE
TO authenticated
USING (bucket_id = 'club-logos');
